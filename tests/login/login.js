...
export class LoginPage {
    ...
    async login() {
        ...
        // QA
        await this.page.goto("https://qa-platform.baap.company/dashboard");
        ...
        //qa for dispatch 
        // await this.page.getByTestId('CG-search-input').fill('Dis');

        // await this.page
        //     .getByTestId("CG-org-select-arrow-4faf5430-6e83-47d1-a5d6-7c977b64e02a")
        //     .locator("path")
        //     .click();
