...
test('test', async ({ page }) => {
  ...
  //Update asset data in Asset master data
  ...
  await page.getByTestId('AM-AMD-AD-edit-button-0').click();
  await page.getByTestId('AM-AMD-AM-description-input').click();
  await page.getByTestId('AM-AMD-AM-description-input').fill('Bigscreen');
