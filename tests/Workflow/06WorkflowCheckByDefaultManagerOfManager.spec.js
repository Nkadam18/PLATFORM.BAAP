...
test('test', async ({ page }) => {
    ...
    await page.getByTestId('add-settings-workflow-approver-input').fill('Shubham');
    await page.waitForTimeout(800);

    await page.getByTestId('add-settings-workflow-approver-option-da972444-a195-4fb4-8a20-67960eafeb26').click();
    await page.waitForTimeout(800);
